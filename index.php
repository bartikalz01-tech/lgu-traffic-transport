...
<body>
    ...
    <div class="form-container">
        ...
        Don't have an account? <span onclick="showSignup()">Sign up</span>
            ...
            <!-- SIGNUP FORM -->
    <form id="signupForm" class="form hidden" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
        <div class="form-header">
        ...
        <div class="input-group">
        <i class="fas fa-envelope"></i>
        <input type="email" name="email" placeholder="Email Address" required value="<?php echo isset($_POST['email']) && isset($_POST['signup']) ? htmlspecialchars($_POST['email']) : ''; ?>">
        </div>
        ...
        <button class="btn" type="submit" name="signup" onclick="showLoading(this)">Create Account</button>
