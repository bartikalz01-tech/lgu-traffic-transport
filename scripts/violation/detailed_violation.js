...
export async function detailedViolationReports(accidentId) {
  ...
  detailedReports.innerHTML = `
    <section class="detailed-reports-overlay">
      ...
      <div class="detailed-reports-container">
        ...
        <h2><i class="fas fa-file-alt"></i> Violation Case Details</h2>

        <!-- Summary Section -->
        <div class="summary-reports">
          <div class="accident-detail-data-left-side">
            <div class="violation-data">
              <p class="description">Violation ID:</p>
              <p class="data" id="accidentId">${data.public_violation_id}</p>
            </div>
            <div class="violation-data">
              <p class="description">Type of Violation:</p>
            ...
            <div class="violation-data">
              <p class="description">Assigned Officer:</p>
          ...
          <div class="accident-detail-data-right-side">
            ...
            <div class="violation-data">
              <p class="description">Escalate to:</p>
              <div class="status-control">
                <select class="organization-select" id="oraganizationSelect">

                </select>
                <span class="organization-badge" id="organizationBadge"></span>
              </div>
            </div>
        ...
        <div class="report-table-section">
          <div class="table-header-actions">
            ...
            <h3><i class="fas fa-users"></i> People Involved <span class="section-badge"><span
                  id="peopleCountBadge">${data.total_people}</span> Persons</span></h3>
        ...
        <div class="report-table-section">
          <div class="table-header-actions">
            <h3><i class="fas fa-car"></i> Vehicles Involved <span class="section-badge"><span
                  id="vehiclesCountBadge">${data.total_vehicles}</span> Vehicles</span></h3>
