...
export function detailedAccidentReport() {
  ...
  detailedReports.innerHTML = `
     <section class="detailed-reports-overlay" id="detailedReports">
        ...
        <div class="summary-reports">
          <div class="accident-detail-data-left-side">
            <div class="accident-data">
              ...
              <p class="data" id="accidentId">ACC-20260115-001</p>
            </div>
            <div class="accident-data">
              <p class="description">Type of Accident:</p>
              <p class="data" id="accidentType">Vehicle Collision</p>
            </div>
            <div class="accident-data">
              <p class="description">Location:</p>
              <p class="data" id="accidentLocation">Road 123, Caloocan City</p>
            </div>
            <div class="accident-data">
